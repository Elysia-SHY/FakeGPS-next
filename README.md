...
2. 从 [Releases 页面](https://github.com/Elysia-SHY/FakeGPS-next/releases/latest) 下载并安装 **FakeGPS-next-v1.4.4-release.apk**；
3. 在 LSPosed 管理器中启用本模块，**作用域只勾选「系统框架 (Android / android)」**，目标应用无需勾选；
4. 重启设备，或软重启 `system_server` 后生效。

### 方式二：免 Root 模式

1. 安装 FakeGPS-next-v1.4.4-release.apk；
